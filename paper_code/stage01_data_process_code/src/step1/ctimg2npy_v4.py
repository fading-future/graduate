...
# def _detect_global_roi(files, sample_count=1000):
...
#     # 稍微缩小一点半径 (0.95)，避免把空气边缘算进去，这有助于解决 P1=0 的问题
#     max_radius = int(np.percentile(all_radii, 90) * 0.95)
...
def process_single_chunk_task(task_data):
    ...
    for i in range(stack.shape[0]):
        ...
        # 归一化
        norm_f = (slice_data - g_p1) / (g_p99 - g_p1 + 1e-6)
