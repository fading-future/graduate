...
LOG_FILE = r"C:\Users\vipuser\Desktop\chendou\latent_ddpm_code\exp_results\exp_08_latent_diffusion\logs\training_log.csv"
...
def plot_ddpm_curves(log_path):
    ...
    # 原始数据背景 (Alpha 低)
    ax1.plot(steps, df['Loss'], color=color_loss, alpha=0.3, linewidth=0.5)
    # 平滑曲线
